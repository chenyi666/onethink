...
<body>
    ...
    <div class="main-title">
        <h2><?php echo isset($info['id'])?'编辑':'新增';?>保修</h2>
    </div>
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            <label class="item-label">报修人<span class="check-tips">（报修业主）</span></label>
            <div class="controls">
        ...
        <div class="form-item">
            <span><label class="item-label">标题</label>（简述一下报修问题）</span>
            <div class="controls">
                <input type="text" class="text input-large" name="intro" value="<?php echo ((isset($info["intro"]) && ($info["intro"] !== ""))?($info["intro"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
