...
<body>
    ...
    <div class="main-title">
        <h2><?php echo isset($info['id'])?'编辑':'新增';?>小区通知</h2>
    </div>
    <form action="<?php echo U();?>" method="post" class="form-horizontal" enctype="multipart/form-data">
        <div class="form-item">
            <label class="item-label">发布人</label>
            <div class="controls">
                <input type="text" class="text input-large" name="addperson" value="<?php echo ((isset($info["addperson"]) && ($info["addperson"] !== ""))?($info["addperson"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            <label class="item-label">活动图片</label>
            <div class="controls">
                <input type="file" class="text input-large" name="img" value="<?php echo ((isset($info["img"]) && ($info["img"] !== ""))?($info["img"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">内容</label>
            <div class="controls textarea input-large">
                <textarea name="content"  value="<?php echo ((isset($info["content"]) && ($info["content"] !== ""))?($info["content"]):''); ?>"></textarea>
            </div>
        </div>
        <div class="form-item">
