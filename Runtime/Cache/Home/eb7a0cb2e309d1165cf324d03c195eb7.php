...
<div class="main">
    ...
    <div class="container-fluid">
        <div class="indexImg row">
            <img src="/Public/Home/onethink/image/3.png" width="100%" />
        </div>
        <div class="blank"></div>
        <div class="container">
            <ul class="list-group fuwuList">
                ...
                <li class="list-group-item"><a href="<?php echo U('home/service/identify');?>" class="text-info"><span class="iconfont">&#xe605;</span>业主认证</a></li>
